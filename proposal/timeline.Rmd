...
- **Deliverable:** A tag in the GitHub repo annotating the milestone of a function (meta)data tagging solution.

***Months 7--8***

- Integrate C++ with R and implement altrep framework for lazy access as well as integrate iRODS functionality.
