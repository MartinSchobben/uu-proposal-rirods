...
We request \$35,800 for the gross salary of MS (project lead) for 0.75 ft working hours a week and overhead expenses (utilities, Travis CI 1 year core plan, and travel expenses for local lab visits). This sum is based on the gross salary for a postdoc in natural sciences, including the applicants years of experience. The remainder of working hours he will spend on developing and giving courses/workshops (see FAIReLABS; Section \@ref(sec:Start)) that entail best practices in data management, reproducible science and data science with R (see e.g., [PAGES workshop youtube](https://www.youtube.com/watch?v=r99jsChi4HU)). The latter activities are not include in the salary request. We also request \$2,500 funding for the attendance of two conference for one person (provisionally, addressing a potential user-base; EGU 2022 Vienna, and the open science community at ICOSRP 2022 Helsinki).
